...
const locale = {
  ...
  "liveMonitor.worker_unavailable": "Waiting for trading worker",
  "liveMonitor.run_not_observed": "No runtime instance observed",
  "liveMonitor.heartbeat_missing": "No heartbeat received",
  "liveMonitor.recent_failure": "Recent execution failure",
  "liveMonitor.heartbeat_delayed": "Heartbeat delayed",
  "liveMonitor.heartbeat_expired": "Heartbeat expired",
  ...
  "profile.exchange.errors.GATE_TESTNET_NETWORK_UNAVAILABLE": "Gate TestNet is unreachable from this environment. Check network, proxy, or firewall settings.",
  "profile.exchange.errors.GATE_TESTNET_AUTH_REJECTED": "The Gate TestNet credential was rejected. Create the key in the TestNet API Keys area.",
  "profile.exchange.errors.GATE_TESTNET_PERMISSION_OR_IP_REJECTED": "Gate TestNet rejected the permission or IP whitelist. Check Spot/Perpetual permissions and server egress IP.",

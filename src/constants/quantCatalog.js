...
export const BUILTIN_STRATEGY_CATALOG = Object.freeze([
  { key: 'strategy_v2_single_ma', name: '\u5355\u5747\u7ebf\u8d8b\u52bf', category: '\u8d8b\u52bf\u8ddf\u968f', market: '\u7f8e\u80a1', description: '\u5355\u5747\u7ebf\u8bc6\u522b\u4e2d\u671f\u8d8b\u52bf' },
  { key: 'strategy_v2_double_ma', name: '\u53cc\u5747\u7ebf\u4ea4\u53c9', category: '\u8d8b\u52bf\u8ddf\u968f', market: '\u52a0\u5bc6\u8d27\u5e01', description: '\u5feb\u6162\u5747\u7ebf\u4ea4\u53c9\u786e\u8ba4\u65b9\u5411' },
  { key: 'strategy_v2_bullish_three_lines', name: '\u4e09\u5747\u7ebf\u591a\u5934\u6392\u5217', category: '\u8d8b\u52bf\u8ddf\u968f', market: '\u7f8e\u80a1', description: '\u591a\u5934\u6392\u5217\u8fc7\u6ee4\u8d8b\u52bf' },
  { key: 'strategy_v2_bullish_three_lines_trend', name: '\u4e09\u5747\u7ebf\u8d8b\u52bf\u8fc7\u6ee4', category: '\u8d8b\u52bf\u8ddf\u968f', market: '\u7f8e\u80a1', description: '\u5747\u7ebf\u4fe1\u53f7\u53e0\u52a0\u65b9\u5411\u8fc7\u6ee4' },
  { key: 'strategy_v2_turtle', name: '\u6d77\u9f9f\u7a81\u7834', category: '\u7a81\u7834\u4ea4\u6613', market: '\u7f8e\u80a1', description: '\u901a\u9053\u7a81\u7834\u4e0e\u6ce2\u52a8\u7387\u7ba1\u7406' },
  { key: 'strategy_v2_indicator_resonance', name: '\u6307\u6807\u5171\u632f', category: '\u591a\u6307\u6807', market: '\u7f8e\u80a1', description: '\u591a\u4e2a\u6280\u672f\u6307\u6807\u5171\u540c\u786e\u8ba4' },
  { key: 'strategy_v2_macd_kdj', name: 'MACD + KDJ \u52a8\u91cf\u7b56\u7565', category: '\u52a8\u91cf\u53cd\u8f6c', market: '\u52a0\u5bc6\u8d27\u5e01', description: 'MACD \u52a8\u91cf\u4e0e KDJ \u4ea4\u53c9' },
  { key: 'strategy_v2_supertrend', name: '\u8d85\u7ea7\u8d8b\u52bf', category: '\u8d8b\u52bf\u8ddf\u968f', market: '\u7f8e\u80a1', description: 'ATR \u6ce2\u52a8\u5e26\u8ddf\u968f\u8d8b\u52bf' },
  { key: 'strategy_v2_market_cap_barbell', name: '\u5e02\u503c\u6760\u94c3', category: '\u7ec4\u5408\u7b56\u7565', market: '\u7f8e\u80a1', description: '\u5927\u76d8\u4e0e\u6210\u957f\u98ce\u683c\u914d\u7f6e' },
  { key: 'strategy_v2_momentum_top_n', name: '\u52a8\u91cf Top N', category: '\u6a2a\u622a\u9762\u52a8\u91cf', market: '\u7f8e\u80a1', description: '\u6309\u6eda\u52a8\u52a8\u91cf\u6392\u540d\u9009\u62e9' },
  { key: 'strategy_v2_low_volatility', name: '\u4f4e\u6ce2\u52a8\u7ec4\u5408', category: '\u7ec4\u5408\u7b56\u7565', market: '\u7f8e\u80a1', description: '\u4f18\u5148\u9009\u62e9\u6ce2\u52a8\u8f83\u4f4e\u7684\u6807\u7684' },
  { key: 'strategy_v2_quality_growth', name: '\u8d28\u91cf\u6210\u957f', category: '\u57fa\u672c\u9762\u7ec4\u5408', market: '\u7f8e\u80a1', description: '\u8d28\u91cf\u4e0e\u6210\u957f\u56e0\u5b50\u7814\u7a76\u7ec4\u5408' }
])
...
export function toCommunityStrategy (item, index = 0) {
  ...
  return {
    ...
    applicable_symbols: source.market === '\u52a0\u5bc6\u8d27\u5e01' ? ['BTC/USDT', 'ETH/USDT'] : ['SPY', 'QQQ'],
    applicable_timeframes: ['15m', '1h', '4h', '1d'],
    purchase_count: 0,
    view_count: 0,
    avg_rating: 0

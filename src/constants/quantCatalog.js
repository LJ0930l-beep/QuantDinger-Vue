...
export const BUILTIN_STRATEGY_CATALOG = Object.freeze([
  ...
  { key: 'strategy_v2_double_ma', name: '\u53cc\u5747\u7ebf\u4ea4\u53c9', category: '\u8d8b\u52bf\u8ddf\u968f', market: '\u52a0\u5bc6\u8d27\u5e01', description: '\u5feb\u6162\u5747\u7ebf\u4ea4\u53c9\u786e\u8ba4\u65b9\u5411', timeframes: ['4h'], instruments: ['BTC/USDT', 'ETH/USDT'], marketType: 'swap', leverageMin: 50, leverageCap: 100 },
  ...
  { key: 'strategy_v2_macd_kdj', name: 'MACD + KDJ \u52a8\u91cf\u7b56\u7565', category: '\u52a8\u91cf\u53cd\u8f6c', market: '\u52a0\u5bc6\u8d27\u5e01', description: 'MACD \u52a8\u91cf\u4e0e KDJ \u4ea4\u53c9', timeframes: ['4h'], instruments: ['BTC/USDT', 'ETH/USDT'], marketType: 'swap', leverageMin: 50, leverageCap: 100 },
  { key: 'strategy_v2_supertrend', name: '\u8d85\u7ea7\u8d8b\u52bf', category: '\u8d8b\u52bf\u8ddf\u968f', market: '\u7f8e\u80a1', description: 'ATR \u6ce2\u52a8\u5e26\u8ddf\u968f\u8d8b\u52bf', timeframes: ['1d'], instruments: ['SPY'] },
  { key: 'strategy_v2_rsi_scalper_5m', name: 'RSI 5\u5206\u949f\u77ed\u7ebf', category: '\u77ed\u7ebf\u52a8\u91cf', market: '\u52a0\u5bc6\u8d27\u5e01', description: '\u7528 RSI \u8d85\u4e70\u8d85\u5356\u8fc7\u6ee4\u77ed\u5468\u671f\u52a8\u91cf', timeframes: ['5m'], instruments: ['BTC/USDT'], marketType: 'swap', leverageMin: 50, leverageCap: 100 },
  { key: 'strategy_v2_breakout_15m', name: 'Donchian 15\u5206\u949f\u7a81\u7834', category: '\u77ed\u7ebf\u7a81\u7834', market: '\u52a0\u5bc6\u8d27\u5e01', description: '\u901a\u9053\u7a81\u7834\u4e0e ATR \u6ce2\u52a8\u7ba1\u7406\u77ed\u7ebf\u8fdb\u51fa', timeframes: ['15m'], instruments: ['ETH/USDT'], marketType: 'swap', leverageMin: 50, leverageCap: 100 },
